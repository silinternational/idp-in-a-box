...
data "template_file" "task_def" {
  ...
  vars {
    ...
    send_get_backup_codes_emails     = "${send_get_backup_codes_emails}"
    send_refresh_backup_codes_emails = "${send_refresh_backup_codes_emails}"
    send_lost_security_key_emails    = "${send_lost_security_key_emails}"
    send_mfa_option_added_emails     = "${send_mfa_option_added_emails}"
    send_mfa_option_removed_emails   = "${send_mfa_option_removed_emails}"
    send_mfa_enabled_emails          = "${send_mfa_enabled_emails}"
    send_mfa_disabled_emails         = "${send_mfa_disabled_emails}"
    ...
    subject_for_get_backup_codes     = "${subject_for_get_backup_codes}"
    subject_for_refresh_backup_codes = "${subject_for_refresh_backup_codes}"
    subject_for_lost_security_key    = "${subject_for_lost_security_key}"
    subject_for_mfa_option_added     = "${subject_for_mfa_option_added}"
    subject_for_mfa_option_removed   = "${subject_for_mfa_option_removed}"
    subject_for_mfa_enabled          = "${subject_for_mfa_enabled}"
    subject_for_mfa_disabled         = "${subject_for_mfa_disabled}"
    subject_for_mfa_manager          = "${subject_for_mfa_manager}"
    subject_for_method_verify        = "${subject_for_method_verify}"
    support_email                    = "${var.support_email}"
    support_name                     = "${var.support_name}"
    lost_security_key_email_days     = "${lost_security_key_email_days}"
    minimum_backup_codes_before_nag  = "${minimum_backup_codes_before_nag}"
    email_repeat_delay_days          = "${email_repeat_delay_days}"
    password_reuse_limit             = "${password_reuse_limit}"
    password_lifespan                = "${password_lifespan}"
    password_expiration_grace_period = "${password_expiration_grace_period}"
    invite_lifespan                  = "${invite_lifespan}"
    invite_grace_period              = "${invite_grace_period}"
    mfa_lifetime                     = "${mfa_lifetime}"
    method_lifetime                  = "${method_lifetime}"
    method_gracePeriod               = "${method_gracePeriod}"
    method_codeLength                = "${method_codeLength}"
    method_maxAttempts               = "${method_maxAttempts}"
    mfa_add_interval                 = "${mfa_add_interval}"
    mfa_review_interval              = "${mfa_review_interval}"
    method_add_interval              = "${method_add_interval}"
    method_review_interval           = "${method_review_interval}"
  }
}
