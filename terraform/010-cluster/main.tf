 ...
 */
module "vpc" {
  source    = "github.com/silinternational/terraform-modules//aws/vpc?ref=2.0.0"
...
module "cloudflare-sg" {
  source = "github.com/silinternational/terraform-modules//aws/cloudflare-sg?ref=2.0.0"
 ...
 */
module "asg" {
  source                  = "github.com/silinternational/terraform-modules//aws/asg?ref=2.0.0"
  app_name                = "${var.app_name}"
  app_env                 = "${var.app_env}"
 ...
 */
module "alb" {
  source          = "github.com/silinternational/terraform-modules//aws/alb?ref=2.0.0"
  app_name        = "${var.app_name}"
  app_env         = "${var.app_env}"
  internal        = "false"
  vpc_id          = "${module.vpc.id}"
